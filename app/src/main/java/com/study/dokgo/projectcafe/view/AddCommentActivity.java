...
public class AddCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText commentContent = (EditText) findViewById(R.id.menu_comment_content);
        EditText commentRate = (EditText) findViewById(R.id.menu_comment_rank);
