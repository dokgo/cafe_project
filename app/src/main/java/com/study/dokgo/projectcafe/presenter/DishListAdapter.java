...
public class DishListAdapter extends
        RecyclerView.Adapter<DishListAdapter.CafeViewHolder> {

    private List<Dish> menuList;
    NetworkAPI networkAPI;

    public DishListAdapter(List<Dish> menuList, NetworkAPI networkAPI) {
